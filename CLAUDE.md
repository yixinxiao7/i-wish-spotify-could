...
- `components/ui/` — SongCard, PlaylistList, PlaylistChooser (shared playlist-picking screen — heading, description, loading/error/empty states, `PlaylistList`), SongListPagination + SongCardSkeleton (shared by every paged song list), + shadcn/ui components
